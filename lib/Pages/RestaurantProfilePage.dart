          ...
          slivers: <Widget>[
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                  background: ImageBackDropAndLogo(backgroundImageUrl: 'images/Burger.jpg', logoImageUrl: 'images/Logo.png')
              )
            ),
            SliverList(
                ...
                Container(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        boxShadow: [BoxShadow(blurRadius: 10.0, offset: Offset(0.0, -5.0), spreadRadius: 10, color: Color(0xBFC27910))],
                        color: Colors.white,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: <Color>[Color(0xFFC2791A), Color(0x00000000)],
                )
              )
            ),
            Center(
